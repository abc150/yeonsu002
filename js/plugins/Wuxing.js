...
*
* @param 커스텀 BG
* @desc (y / n) BG는 bg.png라는 이름으로 img / wuxing /에 있어야합니다.
* @default n
*
* @param Cut Through History
* @desc (y / n) 결과 대화 상자가 기록 창을 잘라야합니까?
* @default n
*
* @param CPU 요소 표시
* @desc (y / n) 컴퓨터 측면에서 어떤 아이콘이 충전되었는지 여부를 확인합니다.
* @default n
*
* @param ---Round Results---
*
* @param 플레이어가 선택한 요소
* @desc 플레이어가 요소를 선택할 때 표시 할 텍스트입니다. CHOSENELEMNT는 선택한 요소로 대체됩니다.
* @default You chose CHOSENELEMNT.
*
* @param 컴퓨터 선택 요소
* @desc 컴퓨터가 요소를 선택할 때 표시 할 텍스트입니다. CHOSENELEMNT는 선택한 요소로 대체됩니다.
* @default Computer chose CHOSENELEMNT.
*
* @param 라운드 승리 메시지
* @desc 라운드에서 이길 때 표시 할 텍스트입니다. WONPOINTS는 획득 한 포인트로 대체됩니다.
* @default You win! +WONPOINTS
*
* @param 라운드 패배 메시지
* @desc 라운드에서 패할 때 표시 할 텍스트입니다. WONPOINTS는 획득 한 포인트로 대체됩니다.
* @default Computer wins, +WONPOINTS
*
* @param 라운드 무승부 메시지
* @desc 라운드에서 무승부일 때 표시 할 텍스트입니다.
...
*
* @param 요소 아이콘 너비
* @desc 요소 아이콘에 사용되는 이미지의 너비
* @default 54
*
* @param 요소 아이콘 높이
* @desc 요소 아이콘에 사용되는 이미지의 높이
* @default 54
*
* @param 요소 아이콘 패딩
* @desc 각 요소 사이의 공간
* @default 1
*
* @param 요소 아이콘 비활성화 된 불투명도
* @desc 비활성화 된 요소의 불투명도 (0 ~ 255)
* @default 100
*
...
*
* @param CPU 레이블 텍스트
* @desc 이러한 요소 아이콘이 컴퓨터의 것임을 나타내는 표시 할 텍스트입니다. 텍스트가 없으면 비워 둡니다.
...
*     WuxingMG elementNumber gameLength
...
Game_Interpreter.prototype.pluginCommand = function (command, args) {
	Wuxing_Game_Interpreter_pluginCommand(this, command, args);
