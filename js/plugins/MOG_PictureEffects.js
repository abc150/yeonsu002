 ...
 * =============================================== == ============================
 * 이미지 표시 시스템에 새로운 기능을 추가합니다.
 * =============================================== == ============================
 * 사용하다.
 * =============================================== == ============================
 * 플러그인 명령을 통해 명령을 사용하십시오.
 *
 * =============================================== == ============================
 * * 위치 *
 * =============================================== == ============================
 ...
 * ---> 호흡 효과 <-----
 *
 * pic_breath : PICTURE ID : true : 파워 : 속도
 *
 * ---> 플로트 효과 <-----
 *
 * pic_float : 사진 ID : true
 *
 * ---> 흔들기 효과 <-----
 *
 * pic_shake : PICTURE ID : true : 전원
 *
 * ---> 떨림 효과 2 <-----
 *
 * pic_shake2 : PICTURE ID : true : 전원
 *
 * ---> 부드러운 효과 <-----
 *
 * pic_smooth : PICTURE ID : true : 파워 : 속도
 *
 * =============================================== == ============================
 * * 애니메이션 *
 * =============================================== == ============================
 ...
 *
 * (참고-이미지의 너비는 프레임 수로 나뉩니다.)
 *
 *
 * =============================================== == ============================
 * * 역사 *
 * =============================================== == ============================
 * (1.3)-Smooth 효과가 추가되었습니다.
 *-효과의 힘과 속도를 정의하는 옵션이 추가되었습니다.
 * (1.2)-모드 2에서 흔들기 기능 추가.
 *
 */
