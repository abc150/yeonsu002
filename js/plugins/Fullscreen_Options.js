...
* @desc 처음 게임을 시작할 때 전체 화면을 강제로 실행 하시겠습니까? true or false Default: false
* @default false
*
* @param Add command to option?
* @desc 옵션 메뉴에 명령을 추가 하시겠습니까? true or false Default: false
* @default false
*
* @param Disable F3?
* @desc F3을 비활성화 하시겠습니까? 기본적으로 스트레치 모드를 적용합니다. true or false Default: false
* @default false
*
* @param Disable F4?
* @desc F4를 비활성화 하시겠습니까? true or false Default: false
* @default false
*
* @help
