 ...
 * =============================================== == ============================
 * 화면에 여러 애니메이션 텍스트를 표시합니다.
 *
 * =============================================== == ============================
 * 명령 플러그인
 * =============================================== == ============================
 * 텍스트를 활성화하려면 아래 명령을 사용하십시오.
 *
 ...
 *-텍스트 색상 변경 추가.
 *-새로운 애니메이션 추가.
 * (v1.2)-지도 변경 후 필요없이 자동 데이터 재설정
 * 명령 플러그인 (clearinfotext) 사용.
 * (v1.1)-클리어 이펙트 사용시 크래시 수정.
 */
