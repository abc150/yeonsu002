...
* =============================================== ============================
*
* 다음과 같은 플러그인 명령을 사용할 수 있습니다.
*
*-텍스트의 속도는 0에서 가장 빠르며 프레임 단위로 지정할 수 있습니다.
...
*
*-이 플러그인 명령을 사용하면 그라디언트 텍스트의 색상을 변경할 수 있습니다.
* 'color1'은 그라디언트 텍스트의 시작점 색상입니다.
* 'color2'는 그라디언트 텍스트의 중간 지점의 색상입니다.
* 'color3'은 그라데이션 텍스트의 끝점 색상입니다.
* 모든 색상은 #FFFFFF와 동일한 문자열 유형으로 설정해야합니다.
* 메시지 그라디언트 색상 1 색상 2 색상 3
*
*-이 플러그인 명령을 사용하면 메시지 창의 행 수를 변경할 수 있습니다.
* Message line number
*
*-이 플러그인 명령을 사용하면 큰 얼굴 비트 맵을 사용할 때 텍스트의 시작 x 위치를 변경할 수 있습니다.
* Message textStartX number
*
*-이 플러그인 명령은 이름 창의 오프셋을 x, y로 설정할 수 있습니다.
* Message name x number
* Message name y number
* Message name padding number
* Message name windowskin skin_name
*
*-이 플러그인 명령은 큰 얼굴 비트 맵의 ​​dx, dy 오프셋을 설정할 수 있습니다.
* Message faceOX dx
* Message faceOY dy
*
*-이 플러그인 명령을 사용하면 메시지 창의 뒷면에 큰 얼굴 비트 맵을 표시할지 여부를 설정할 수 있습니다.
* '값'을 0, -1로 설정하면 메시지 창 뒷면에 비트 맵이 표시됩니다.
* 그렇지 않으면 '값'이 1 이상인 경우 앞에 표시됩니다.
* Message faceZ value
*
*-이 플러그인 명령을 사용하면 탭의 최대 너비를 설정할 수 있습니다.
...
* 큰 얼굴 비트 맵 (상체 이미지)
* =============================================== ============================
* 이름에 "Big_"과 같은 접두사를 추가하는 것은
* img / faces 폴더의 흉상 용 비트 맵. 따라서 흉상 이미지를 배치합니다.
* img / faces 폴더에서 파일 이름을 'Big_'으로 시작하도록 설정해야합니다.
* 항상 리소스 이름을 확인하십시오.
* =============================================== ============================
* 텍스트 코드 목록 (한글)
* =============================================== ============================
* 이러한 텍스트 코드를 사용하려면 언어 설정을 한국어로 설정해야합니다.
*
* \ 색 [색상명]
* \ 속도 [값]
* \ 테두리 색 [색상명]
...
* \ 크기 [숫자]
* \ 탭! : 탭의 크기는 8입니다.
* \ 캐리지 리턴! : X를 시작 위치로 되돌립니다.
* \ 효과음 <효과음 명>
* \ 그림 표시 <그림 번호, 그림 이름, 원점 번호, X 좌표, Y 좌표>
* \ 그림 제거 [그림 번호]
* \ 아이템 [번호]
* \ 무기 구 [번호]
* \ 방어구 [번호]
...
* \ 상태 [번호]
* \ 스킬 [번호]
* \ 얼굴 <페이스 칩 이름, 페이스 칩 업그레이드>
*
* =============================================== ============================
* 색상 표 (한글)
* =============================================== ============================
*이 색상을 사용하려면 언어 설정을 한국어로 설정해야합니다.
*
* 청록, 청록색, c_aqua
* 검은 색, 검정, c_black
* 파란색, 파랑, c_blue
